      ...
      <div className="flex flex-col gap-6">
        ...
        {!profile.isPremium && (
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 rounded-xl border border-amber-200 dark:border-amber-800/40 p-6 shadow-sm">
            ...
            <p className="text-sm text-amber-800 dark:text-amber-200/80 mb-4">
              Profitez de la recommandation IA pour développer votre réseau de mentorat, mettre en avant vos publications, Propulser votre expertise auprès des étudiants et des institutions.
            </p>
            <button
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {profile.isPremium ? (
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 text-center">
                <div className="w-10 h-10 mx-auto bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mb-2"><ShieldCheck className="w-5 h-5" /></div>
                <span className="text-xs font-bold text-slate-700">Mentor Vérifié</span>
              </div>
            ) : (
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-3 text-center opacity-50 grayscale">
                <div className="w-10 h-10 mx-auto bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mb-2"><ShieldCheck className="w-5 h-5" /></div>
                <span className="text-xs font-bold text-slate-700">Mentor (Bloqué)</span>
              </div>
            )}
          </div>
        </div>
